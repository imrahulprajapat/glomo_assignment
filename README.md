...
```bash
git clone <https://github.com/imrahulprajapat/glomo_assignment.git>
cd glomo_assignment
...
| Name  | Email                                         | PIN  |
| ----- | --------------------------------------------- | ---- |
| Alice | [alice@example.com](mailto:alice@example.com) | 1234 |
| Bob   | [bob@example.com](mailto:bob@example.com)     | 5678 |
